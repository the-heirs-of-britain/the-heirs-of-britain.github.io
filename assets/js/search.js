...
if (typeof variable !== "undefined") {
  ...
  fixedsearch = (function () {
    var overlay = document.querySelector("[role=search-overlay]"); // search container
    ...
    function search_init() {
      if (first_run) {
        load_script(window.location.origin + "/js/search.js")
          .then(() => {
        ...
        for (let item in results.slice(0, 5)) {
          ...
          search_items =
            ...
            `<div class="px-2 mt-1 hover:border-l-[3px] hover:border-heraldic-blue focus:outline-none focus:ring-2 focus:ring-heraldic-blue relative hover:bg-black/20">
                ...
                <p class="mt-1 mb-1">
                    <i class="fas fa-calendar"></i>&nbsp; ${results[item].item.date}
            </p>
        <p class="-mt-1">
